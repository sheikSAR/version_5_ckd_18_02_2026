...
class Particle {
  ...
  private generateRandomPos(x: number, y: number, mag: number, width: number, height: number): Vector2D {
...
const DEFAULT_WORDS = ["EFSD", "MDRF", "SRL", "KARE"]
...
export function ParticleTextEffect({
  ...
  const animate = () => {
    ...
    if (frameCountRef.current % wordChangeInterval === 0) {
